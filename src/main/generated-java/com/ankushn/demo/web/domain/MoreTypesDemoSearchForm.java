...
public class MoreTypesDemoSearchForm extends GenericSearchForm<MoreTypesDemo, Integer, MoreTypesDemoSearchForm> {
    ...
    protected Range<MoreTypesDemo, Double> numberFloatRange = newRange(MoreTypesDemo_.numberFloat);
    ...
    protected PropertySelector<MoreTypesDemo, Double> numberFloatSelector = newPropertySelector(MoreTypesDemo_.numberFloat);
    ...
    public Range<MoreTypesDemo, Double> getNumberFloatRange() {
    ...
    public PropertySelector<MoreTypesDemo, Double> getNumberFloatSelector() {
